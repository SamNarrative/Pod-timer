    ...
    <nav>
      <ul>
        <li>
          ...
          >
            <Tippy content="Dashboard" placement="right" delay="300">
              <svg
        ...
        <li>
          ...
          >
            <Tippy content="Settings" placement="right" delay="300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="-2 -2 24 24"
                width="24"
...
function PeriodLengthsSettings() {
  return (
    <div>
      <h4>Period Lengths</h4>
      <div id="lengthControls">
        <SessionControl title="session length" id="session" type="session" />
        <BreakControl title="break length" id="break" type="break" />
      </div>
    </div>
  );
}
...
function BreakSettings() {
  ...
  return (
    <div>
      <h4>Breaks</h4>
      <div id="skipBreakWrapper">
        <UISwitch text={'Skip Breaks'} startState={skipBreak} />
      </div>
    </div>
  );
}
    ...
    <div id="dashboard">
      <section id="dashHeader">
        ...
        <div id="refreshButton" onClick={() => refreshPage()}>
          <Tippy content="Refresh Dashboard" placement="bottom" delay="300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
